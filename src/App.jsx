            ...
            <>
              ...
              {[
                ...
                <div key={row.label} style={{ ...cardS, background: row.bg, border: `1px solid ${B.blushDark}` }}>
                  ...
                  <div style={{ fontSize: "26px", fontWeight: 700, color: row.color, marginBottom: "8px" }}>
                    {fmtUSD(row.usdTotal)}
                  </div>
                  {/* Breakdown: CRC part + USD part */}
                  <div style={{ display: "flex", gap: "8px" }}>
                    <div style={{ flex: 1, background: B.white, borderRadius: "8px", padding: "8px 10px" }}>
                      <div style={{ fontSize: "10px", color: B.textLight, fontWeight: 600, marginBottom: "2px" }}>CRC portion</div>
                      <div style={{ fontSize: "13px", fontWeight: 600, color: row.color }}>{fmtCRC(row.crcPart)}</div>
                      <div style={{ fontSize: "10px", color: B.textLight }}>{fmtUSD(row.crcPart / monthRate)} equivalent</div>
                    </div>
                    <div style={{ flex: 1, background: B.white, borderRadius: "8px", padding: "8px 10px" }}>
                      <div style={{ fontSize: "10px", color: B.textLight, fontWeight: 600, marginBottom: "2px" }}>USD portion</div>
                      <div style={{ fontSize: "13px", fontWeight: 600, color: row.color }}>{fmtUSD(row.usdPart)}</div>
                      <div style={{ fontSize: "10px", color: B.textLight }}>{fmtCRC(row.usdPart * monthRate)} equivalent</div>
                    </div>
                  </div>
